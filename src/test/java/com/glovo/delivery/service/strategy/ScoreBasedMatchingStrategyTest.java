...
class ScoreBasedMatchingStrategyTest {
    ...
    void shouldReturnEmptyForNoCouriers() {
        Order order = new Order(new Point(50, 50), new Point(60, 60), 5);
    ...
    class ScoringFormula {
        ...
        void shouldCalculateCorrectScore() {
            ...
            Order order = new Order(new Point(3, 4), new Point(60, 60), 6);
        ...
        void higherPriorityShouldReduceScore() {
            ...
            Order highPriority = new Order(new Point(50, 50), new Point(60, 60), 10);
            Order lowPriority = new Order(new Point(50, 50), new Point(60, 60), 1);
